...
const DoctorHomeCard = () => {
  return (
    <div className="relative h-50 w-[90vw] sm:w-sm overflow-hidden mx-4 bg-white shadow-lg inset-shadow-sm/50 rounded-tr-2xl rounded-bl-2xl sm:h-64 transition-transform duration-300 ease-in-out cursor-pointer hover:scale-[1.02]">
